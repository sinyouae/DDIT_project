      ...
      <div class="col-md-7 d-flex flex-center">
        <div class="p-4 p-md-5 flex-grow-1">
          <div class="text-center text-md-start">
            <h4 class="mb-0"> 아이디를<br> 잊어버리셨나요?</h4> <br>
            <p class="mb-4">이메일을 입력하면 재설정 링크를 보내드립니다.</p>
          </div>
          <div class="row justify-content-center">
            <div class="col-sm-8 col-md">
              <form class="mb-3" id="findIdForm" action="/account/findId.do" method="post">
                <input class="form-control" type="email" name="memEmail" placeholder="Email address" />
                <div class="mb-3"></div>
                <button class="btn btn-primary d-block w-100 mt-3" type="button" id="findIdBtn">전송</button>
              </form>
