...
<html>
  <head>
	...
	<link rel="apple-touch-icon" sizes="180x180" href="${pageContext.request.contextPath}/resources/design/public/assets/img/favicons/icons/spot-illustrations/IRIS3.png">
	<link rel="icon" type="image/png" sizes="32x32" href="${pageContext.request.contextPath}/resources/design/public/assets/img/favicons/icons/spot-illustrations/IRIS3.png">
	<link rel="icon" type="image/png" sizes="16x16" href="${pageContext.request.contextPath}/resources/design/public/assets/img/favicons/icons/spot-illustrations/IRIS3.png">
	<link rel="shortcut icon" type="image/x-icon" href="${pageContext.request.contextPath}/resources/design/public/assets/img/favicons/icons/spot-illustrations/IRIS3.png">
	...
	<link href="${pageContext.request.contextPath}/resources/design/public/vendors/dropzone/dropzone.css" rel="stylesheet" />
    ...
    <main class="main" id="top">
      <div class="container" data-layout="container">
        ...
        <div class="content pb-0">
			...
			<div class="card d-flex flex-row" style="height: 91vh">
...
<%--     <script src="${pageContext.request.contextPath}/resources/design/public/vendors/fullcalendar/index.global.min.js"></script> --%>
    <script src="${pageContext.request.contextPath}/resources/design/public/vendors/flatpickr/flatpickr.min.js"></script>
    <script src="${pageContext.request.contextPath}/resources/design/public/vendors/dayjs/dayjs.min.js"></script>
    ...
    <script src="${pageContext.request.contextPath}/resources/design/public/vendors/jquery/jquery.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/design/public/vendors/datatables.net/dataTables.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/design/public/vendors/datatables.net-bs5/dataTables.bootstrap5.min.js"></script>
	<script src="${pageContext.request.contextPath}/resources/design/public/vendors/datatables.net-fixedcolumns/dataTables.fixedColumns.min.js"></script>
	...
	<script src="${pageContext.request.contextPath}/resources/design/public/vendors/simplebar/simplebar.min.js"></script>
	 <script src="${pageContext.request.contextPath}/resources/design/public/vendors/sortablejs/Sortable.min.js"></script> 
