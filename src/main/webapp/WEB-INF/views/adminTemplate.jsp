...
<html>
  <head>
	...
	<link rel="icon" type="image/png" sizes="32x32" href="${pageContext.request.contextPath}/resources/design/public/assets/img/icons/spot-illustrations/IRIS3.png">
  ...
  <body>
    ...
    <main class="main" id="top">
      <div class="container-fluid" data-layout="container-fluid">
        ...
        <div class="content w-100 pb-0" style="box-sizing: border-box;">
        
			<tiles:insertAttribute name="header"/>
			<div class="card d-flex flex-row w-100" style="height: 91vh">
